...
\begin{titlepage}\centering
  ...
  \begin{tabular}{lll}
    \textbf{Roll No.} & \textbf{Name} & \textbf{Email}\\[3pt]
    2025201053 & Chakradhar Kotha & chakradhar.kotha@students.iiit.ac.in\\
    2025201071 & Kagana Karthikeya & kagana.karthikeya@students.iiit.ac.in\\
    2025202024 & Venkata Siva Sai Krishna Pokuri & krishna.pokuri@students.iiit.ac.in\\
  \end{tabular}\\[0.8cm]
  \textit{GitHub (source):}\\[0.15cm]
  \href{https://github.com/chakradhar-7/Sports-Highlights-Briefing/tree/main}{\texttt{github.com/chakradhar-7/Sports-Highlights-Briefing/tree/main}}\\[0.5cm]
  \textit{Live demo (Streamlit Cloud):}\\[0.15cm]
  \href{https://sports-highlight-briefing.streamlit.app/}{\texttt{sports-highlight-briefing.streamlit.app}}\\[1cm]
...
\begin{itemize}[noitemsep]
  ...
  \item BART-large-MNLI (0.617) provides the best zero-shot accuracy but at 506\,ms per sample — prohibitively slow for a full feed refresh at scale when many headlines are fetched. Its main weakness is \textit{Other Sports} (F1 = 0.35) and Badminton (F1 = 0.41).
...
\textbf{Figure note.} The UI screenshots below were captured with \textbf{40} articles fetched to better populate analytics plots; the public deploy defaults to \textbf{15} articles per refresh (configurable up to 80) as a courtesy to CPU/RAM limits on Streamlit Community Cloud.
...
\bibitem{anthropicSonnet}
Anthropic (2026). \textit{Claude}: AI assistant—including \textbf{Claude Sonnet}—used for coding, drafting, and documentation support.
